...
| visits_Per_Librarian| Visits per Libraian FTE | Numerical  | Any number| This is the total average number of library visitors per librarian, who is a full-time employee (FTE). | 
